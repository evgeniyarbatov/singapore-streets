...
class TestCanonicalStreets(unittest.TestCase):
    def test_canonicalize_strips_direction(self):
    ...
    def test_build_canonical_table_groups_direction_variants(self):
    ...
    def test_build_canonical_table_without_bare_form(self):
    ...
    def test_write_canonical_table(self):
